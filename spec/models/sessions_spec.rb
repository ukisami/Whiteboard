...
describe Sessions do
  ...
  describe 'being created' do
    ...
    it 'increments Sessions#count' do
  ...
  describe 'allows legitimate logins:' do
    ['123', '1234567890_234567890_234567890_234567890',
     'hello.-_there@funnychar.com'].each do |login_str|
      it "'#{login_str}'" do
        lambda do
          u = create_sessions(:login => login_str)
  ...
  describe 'allows legitimate emails:' do
    ['foo@bar.com', 'foo@newskool-tld.museum', 'foo@twoletter-tld.de', 'foo@nonexistant-tld.qq',
     ...
     'domain@can.haz.many.sub.doma.in', 'student.name@university.edu'
      ...
      it "'#{email_str}'" do
        lambda do
          u = create_sessions(:email => email_str)
  ...
  describe 'allows legitimate names:' do
    ['Andre The Giant (7\'4", 520 lb.) -- has a posse',
     '', '1234567890_234567890_234567890_234567890_234567890_234567890_234567890_234567890_234567890_234567890',
      ...
      it "'#{name_str}'" do
        lambda do
          u = create_sessions(:name => name_str)
  ...
  it 'does not rehash password' do
    ...
    Sessions.authenticate('quentin2', 'monkey').should == sessions(:quentin)
  end
  ...
  it 'authenticates sessions' do
    Sessions.authenticate('quentin', 'monkey').should == sessions(:quentin)
  end

  it "doesn't authenticate sessions with bad password" do
    Sessions.authenticate('quentin', 'invalid_password').should be_nil
  end

 if REST_AUTH_SITE_KEY.blank?
   # old-school passwords
   it "authenticates a user against a hard-coded old-style password" do
     Sessions.authenticate('old_password_holder', 'test').should == sessions(:old_password_holder)
   end
 else
   it "doesn't authenticate a user against a hard-coded old-style password" do
     Sessions.authenticate('old_password_holder', 'test').should be_nil
   end
   ...
   it "takes longer than #{desired_encryption_expensiveness_ms}ms to encrypt a password" do
     test_reps = 100
     start_time = Time.now; test_reps.times{ Sessions.authenticate('quentin', 'monkey'+rand.to_s) }; end_time   = Time.now
